...
namespace library\user\login\captcha;
...
class Captcha
{
    ...
    function create($scene)
    {
        ...
        for ($i = 0; $i < 4; $i++) {
            // 逐个绘制验证码中的字符
            imagettftext($image, rand(20, 38), rand(0, 30), $i * 50 + 25, rand(30, 70), $this->color($image), Variables::getLibPath("user", 'login', 'captcha', 'fonts', 'Bitsumishi.ttf'), $str[$i]);
        }
